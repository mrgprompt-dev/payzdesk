...
export default function ForgotPasswordPage() {
  ...
  const sendOtp = async (phone: string) => {
    setOtpSending(true)
    try {
      await apiClient.post('/auth/otp/send', { phone, purpose: 'forgot-password' })
      startCooldown()
    } finally {
      setOtpSending(false)
    }
  ...
  const onStep2 = async (data: Step2) => {
    ...
    try {
      ...
      setServerSuccess('Password reset successfully! Redirecting...')
    ...
    <div className="auth-page">
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 0, marginBottom: 24, padding: '0 8px', animation: 'fadeIn var(--transition-base)' }}>
          ...
          <div style={{ marginLeft: 10, fontSize: 13, color: 'var(--text-inverted)', fontWeight: 500, textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>
            Step {step} of 2
          </div>
        </div>
        ...
        <div className="auth-card">
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    <span style={{
                      ...
                      fontSize: 16, color: 'var(--text-secondary)', userSelect: 'none', fontWeight: 600,
                    }}>+91</span>
                    <input
                      ...
                      style={{ paddingLeft: 52, ...inputStyle(!!form1.formState.errors.phone) }}
                      autoFocus
                    />
                  </div>
          ...
          {step === 2 && step1Data && (
            <>
              ...
              >
                ...
                {/* Resend / back row */}
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, marginTop: -6, padding: '0 4px' }}>
                  <button
                    type="button"
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      className="form-input"
                      style={{ paddingRight: 46, ...inputStyle(!!form2.formState.errors.password) }}
                    />
                  ...
                  {form2.formState.errors.password && (
                    <p className="field-error">{form2.formState.errors.password.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      className="form-input"
                      style={{ paddingRight: 46, ...inputStyle(!!form2.formState.errors.confirmPassword) }}
                    />
                  ...
                  {form2.formState.errors.confirmPassword && (
                    <p className="field-error">{form2.formState.errors.confirmPassword.message}</p>
                  )}
                </div>
          ...
          {/* Login link */}
          <p style={{ textAlign: 'center', fontSize: 14, color: 'var(--text-secondary)', marginTop: 32 }}>
